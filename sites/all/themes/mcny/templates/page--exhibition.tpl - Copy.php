        ...
        <div class="col-lg-12 no-padding-lr">
            ...
            <div class="breadcrumb exhibition-breadcrumb bg-green-tree no-borders no-border-radius ribbon-container case-study-breadcrumb" style="background-color: <?php echo $taxonomyPageCategory->field_exhibition_category_color['und'][0]['rgb']; ?> !important;">
                ...
                <div class="breadcrumb-navigation">
                    ...
                    <?php echo (!empty($node->field_exhibition_sub_category['und'][0]['value'])) ? $node->field_exhibition_sub_category['und'][0]['value'] : ''; ?>
                </div>

                <div id="case-study-page-title" class="active-page-title-margin <?php echo ($hasLabel) ? 'active-page-title-with-label' : ''; ?>">
                    <span class="active">
                ...
                <div class="breadcrumb-buttons-container">
                    <div class="pull-left">
                        ...
                        <div class="visible-xs">
                            <div class="dropdown">
                                <button id="dLabel" type="button" aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="btn btn-default dropdown-toggle">
                                    <span id="selected">Select Sections</span>
                                    <span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dLabel">
                                    <li><a href="#activists">Meet the Activists</a></li>
                                    <li><a href="#objects_and_images">Objects and Images</a></li>
                                    <li><a href="#timeline">Timeline</a></li>
                                    <li><a href="<?php echo base_path(); ?>class-room/lesson-plans/<?php echo $taxonomyPageCategoryUrl; ?>">Lesson Plans</a></li>
                                </ul>
                            </div>
                        </div>

                        <div class="visible-lg visible-md visible-sm">
                            <a href="#activists" class="btn btn-default no-border-radius btn-breadcrumb green-tree"
                            ...
                            <a href="#objects_and_images" class="btn btn-default no-border-radius btn-breadcrumb green-tree"
                               style="background-color: <?php echo (!empty($taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'])) ? $taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'] : '#ccc'; ?> !important;">
                                Objects and Images
                            </a>
                            <a href="#timeline" class="btn btn-default no-border-radius btn-breadcrumb green-tree"
                               style="background-color: <?php echo (!empty($taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'])) ? $taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'] : '#ccc'; ?> !important;">
                                Timeline
                            </a>
                        </div>
                    ...
                    <div class="pull-right">
                        <a href="<?php echo base_path(); ?>class-room/lesson-plans/<?php echo $taxonomyPageCategoryUrl; ?>" class="btn btn-default no-border-radius btn-breadcrumb btn-lessons transparent visible-lg visible-md visible-sm">
                            Lessons
                        </a>
                    </div>
                ...
                <div id="ribbon-1" class="ribbon bg-green-tree-light visible-lg visible-md visible-sm"
                     style="background-color: #fff <?php echo ''; //(!empty($taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'])) ? $taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rgb'] : '#ccc'; ?> !important;">
...
<div class="row">
    <div class="container">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding-lr overflow-hidden">
            ...
            <?php if(strtolower($taxonomyPageLabel->name) == 'from the archive' || strtolower($taxonomyPageLabel->name) == 'coming soon'): ?>
                <div id="ribbon-2" class="ribbon ribbon-mobile bg-green-tree-light visible-xs"
                     style="background-color: #fff <?php echo ''; //(!empty($taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rbg'])) ? $taxonomyPageCategory->field_exhibition_category_bg['und'][0]['rbg'] : '#ccc'; ?> !important;">
                    <div class="node-label">
                        <?php echo $taxonomyPageLabel->name; ?>
                    </div>
                    <div class="node-date">
